...
# - return_messages=True 옵션을 주면 Message Class로 받음(채팅으로 활용)
# - False이면 Text로 출력
...
chain.predict(question = "My name is woohee")
chain.predict(question = "I live in Gwang-Ju")
